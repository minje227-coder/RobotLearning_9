...
class BDDLBaseDomain(SingleArmEnv):
    ...
    def _generate_object_state_wrapper(
        ...
        # print("object", self.objects_dict.keys()) #dict_keys(['akita_black_bowl_1', 'akita_black_bowl_2', 'cookies_1', 'glazed_rim_porcelain_ramekin_1', 'plate_1'])
        # print("fixture", self.fixtures_dict.keys()) #fixture dict_keys(['wooden_cabinet_1', 'flat_stove_1'])
