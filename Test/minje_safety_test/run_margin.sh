#!/usr/bin/env bash
# VLSA-1 (robot0 safety), delay=10, margin sweep. seeds 0-49. GPUs 1 and 3.
...
# GPU1: margins 0, 0.04, 0.08 ; GPU3: 0.02, 0.06, 0.10  (각 3개 순차)
( runjob 1 0.0 ; runjob 1 0.04 ; runjob 1 0.08 ) &
( runjob 3 0.02 ; runjob 3 0.06 ; runjob 3 0.10 ) &
wait
echo MARGIN_DONE
